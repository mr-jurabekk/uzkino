...
<section id="home-banner-slider" class="iq-main-slider p-0 iq-rtl-direction swiper banner-home-swiper overflow-hidden"
         data-swiper="home-banner-slider">
    <div class="slider m-0 p-0 swiper-wrapper home-slider">

        <?php foreach ($allSlides as $slide): ?>
        <?php $img = getImage('slider', $slide['id'], $slide['image']) ?>
        <?php $trailer = getImage('slider', $slide['id'], $slide['trailer']) ?>

        <div class="swiper-slide  slide swiper-bg" style="background-image: url('<?=$img?>')">
            <div class="container-fluid position-relative h-100">
                <div class="slider-inner h-100">
                    <div class="row align-items-center  iq-ltr-direction h-100 ">
                        <div class="col-lg-7 col-md-12">

                            <h1 class="slider-text big-title title text-uppercase" data-iq-gsap="onStart" data-iq-position-x="-150"
                                data-iq-position-y="0" data-iq-duration="1" data-iq-delay=".4"><?=$slide['name']?></h1>
                            <div class="d-flex flex-wrap align-items-center r-mb-23" data-iq-gsap="onStart"
                                ...
                                <div class="slider-ratting d-flex align-items-center mr-4 mt-2 mt-md-3">
                                    ...
                                    <span class="text-white ml-2"><?=$slide['rating']?></span>
                                </div>
                                <div class="d-flex align-items-center mt-2 mt-md-3">
                                    <span class="badge badge-secondary p-2">Davomiyligi:</span>
                                    <span class="ml-3"><?=$slide['duration']?></span>
                                </div>
                                <p data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="150" data-iq-duration="1"
                                   data-iq-delay=".5">
                                    <?=$slide['description']?>
                                </p>
                            </div>
                            <div class="trending-list" data-wp_object-in="fadeInUp" data-delay-in="1.2">
                                <div class="text-primary title starring">
                                    Yulduzlar: <span class="text-body"><?=$slide['starring']?></span>
                                </div>
                                <div class="text-primary title genres">
                                    Janri: <span class="text-body"><?=$slide['genre']?></span>
                                </div>

                            </div>
                            <div class="d-flex align-items-center r-mb-23" data-iq-gsap="onStart" data-iq-position-x="0"
                                 data-iq-position-y="150" data-iq-duration="1" data-iq-delay=".6">
                                <a href="<?=$trailer?>" target="_blank" class="btn btn-hover iq-button"><i class="fa fa-play mr-2"
                                                                                               aria-hidden="true"></i>Hoziroq tomosha qiling</a>
                            </div>
                        </div>
                        <div class=" col-lg-5 col-md-12 trailor-video iq-slider d-none d-lg-block">
                            <a href="<?=$trailer?>" class="video-open playbtn" tabindex="0">
                    ...
                    <polygon class="triangle" fill="none" stroke-width="7" stroke-linecap="round"
                             stroke-linejoin="round" stroke-miterlimit="10" points="73.5,62.5 148.5,105.8 73.5,149.1 ">
                                ...
                                <span class="w-trailor">Trailerni Ko'rish</span>
                            </a>
                        </div>
                    </div>
                </div>
