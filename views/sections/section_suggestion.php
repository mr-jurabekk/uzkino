                        ...
                        <?php foreach ($suggestedMovies as $movie): ?>
                            ...
                            <li class="swiper-slide slide-item">
                                <div class="block-images position-relative">
                                    <div class="img-box">
                                        <img src="<?=$img?>" class="img-fluid w-100" style="height: 175px; object-fit: cover" loading="lazy" alt="">
                                    </div>
                                    <div class="block-description">
                                        ...
                                        <div class="hover-buttons">
                                            <a href="?route=movie-view&id=<?=$movie['id']?>" role="button" class="btn btn-hover">
